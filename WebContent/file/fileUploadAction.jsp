...
<head>
<meta charset="UTF-8">
<title>파일업로드 처리할 서버페이지 fileUploadAction.jsp</title>
</head>
<body>
	<%
		...
		new FileDAO().upload(taskTitle, course, studentName,title, content, fileName, fileRealName);
		   
		
		out.write("업로드하기위해 선택한 파일의 원본이름 : " +  fileName  + "<br>");
		out.write("실제 upload폴더에 업로드된 파일이름 : " +  fileRealName  + "<br>");
