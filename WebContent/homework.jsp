                ...
                <main>
					<div class="container-fluid">
						<div class="row">
							...
							<div class="col-md-10">
								<input type="text" name="tasktitle" width="100%">
							</div>
							<div class="col-md-2">
								제출방법
							</div>
							<div class="col-md-10">
								<input type="radio" name="taskmethod" value="온라인" checked> 온라인 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<input type="radio" name="taskmethod" value="오프라인"> 오프라인
							</div>
							<div class="col-md-2">
								제출기간
							</div>
							<div class="col-md-10">
								<input type="date" name="period" min="<%=today%>" value="<%=today %>" width="100%">
								 ~ 
								<input type="date" name="period" min="<%=today%>" width="100%"> 
							</div>
						</div>
					</div>
                </main>
