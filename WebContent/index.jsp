...
List<ScheduleDTO> list = sdao.getScheduleList();
NoticeDAO ndao = new NoticeDAO();
NoticeDTO ndto = new NoticeDTO();
List<NoticeDTO> nlist = ndao.getBoardList();
...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
					...
					<%--bx슬라이더 쓰는 부분--%>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">학사일정 및 공지사항</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Schedule & Notice</li>
                        </ol>
                        <div class="row">
	                        <!-- 달력부분 -->
	                        <div class="col-xl-6">
	...
	<%
											       ...
											       int sYear = 0,
											       	   ...
											       	   eMonth = 0,
											       	   eDate = 0;
											       List<String> scheduleDate = sdao.getSdate();
											       ...
											       for(String s : scheduleDate) {
											       	...
											       	if( (year == sYear && (month+1) == sMonth && index == sDate) || (year == eYear && (month+1) == eMonth && index == eDate) ) {
												       	...
												       	out.println("<font size=0.8><b><span style='color: #0d6efd;'>" + sdto.getTitle() + "</span></b></font><br>");
											       	} 
			                        ...
			                        <div class="row">
			                        	<div class="card-body">
			                   	           <table border="1"  style="border-collapse: collapse; border-color: lightgrey;" class="lec"> 
		                                   		...
		                                   		%>
		                                   				<tr align="center">
		                                   					<td><%=ndto.getNclass() %></td>
		                                   					<td>
		                                   						<a href="<%=request.getContextPath()%>/notice/viewNotice.jsp?no=<%=ndto.getNo()%>">
		                                   							<%=ndto.getTitle() %>
		                                   						</a>
		                                   					</td>
			                   	           	...
			                   	           	<p align="right">
												<small><a href="${path}/menu/notice.jsp" style="text-decoration: none; color:black;">더보기...</a></small>
											</p>
			                            </div>
			                        </div>
	                            </div>
