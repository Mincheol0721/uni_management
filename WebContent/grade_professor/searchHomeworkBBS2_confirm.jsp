	...
	<div class="row">
                   	          ...
                   	          <%
              	          		...
              	          		%>
                   	          		...
                   	          		<tr align="center" style="border-bottom: 1px, solid, lightgrey;" id="searchZone">
                   	           			...
                   	           			<td width=5%><a href="homeWorkModify_confirm.jsp?num=<%=home.getNum()%>&studentName=<%=studentName%>&cname=<%=cname%>" style="text-decoration: none"><%=home.getTitle()%></a></td>
                        	...
                        	if(count>0) {
                        		...
                        		for(int i=startPage; i<=endPage; i++) {
                        			%><a href="homework_confirm.jsp?pageNum=<%=i%>&studentName=<%=studentName%>&cname=<%=cname%>&searchText=<%=searchText%>&searchField=<%=searchField%>" id="a">[<%=i%>]</a><%
                        		}
